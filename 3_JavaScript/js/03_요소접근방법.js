// id로 접근하기
function fnTest1(){
    // id 가 div1인 요소를 얻어와 상수형 변수 div1에 저장
...
// 태그명으로 접근하기
function fnTest3(){
    // 문서 내 존재하는 모든 li요소를 얻어와 배열형식으로 반환
...
function fnTest6(){
    ...
    // (여러 요소가 선택된 경우 첫번째 요소만 선택)
    document.querySelector("#cssTest").style.border="3px solid blue";
    document.querySelector("#cssTest>div").style.border="3px solid red";
...
function inputEnter(){
    ...
    // -> 꾹 누르고 있을 경우 연속적으로 함수가 호출되느 문제 발생
    // -> keyup 이용(1회만 인식)
