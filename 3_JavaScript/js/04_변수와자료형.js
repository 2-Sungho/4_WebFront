...
function typeTest(){
    ...
    // 블록 변수 범위 'temp1'을(를) 다시 선언할 수 없습니다.
    
    if(temp1==100){
        // 블록 범위 확인
        let temp2=200;
        const temp3=300;
        // temp3=400; // 상수형 변수 변경 불가
    }
    ...
    // boolean
    const isTrue=true;
    typeBox.innerHTML+="<br><br>isTure: "+isTrue+"/"+typeof isTrue;
