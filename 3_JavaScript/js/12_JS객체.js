...
document.getElementById("btn2").addEventListener("click",function(){
    ...
    stdList.push(new Student(5,7,"이길동"));
    stdList.push(new Student(4,5,"최길동"));

    div2.innerHTML=""; // 이전 내용 삭제

    // for of : 배열/컬렉션 요소 반복 접근
    for(let std of stdList){

        // for in : 객체의 키 반복접근용 for문
        for(let key in std){
...
document.getElementById("btn3").addEventListener("click",function(){
    ...
    const member='{"memberId":"user01","memberPw":"pass01","age":20}'; // 문자열
