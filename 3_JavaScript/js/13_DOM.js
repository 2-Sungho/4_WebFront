...
document.getElementById("btn1").addEventListener("click",function(){
    ...
    // 부모
    // 요소.parentNode : 요소의 부모 노드 탐색해서 반환
    
    // 자식
    // 요소.childNodes : 요소의 자식 요소를 모두 반환(NodeList 형태)
    ...
    // #test의 자식 노드 중 5번 인덱스이 다음 형제 노드
    console.log(test.childNodes[5].nextSibling);

    // 노드 탐색 구문 연속 작성
    // #test으 자식 노드 중 5번 인덱스의 이전 형제 노드의 이전 형제 노드
...
document.getElementById("btn2").addEventListener("click",function(){
    ...
    // #test의 자식 요소 중 2번 인덱스의 이번 형제 요소 클릭 시
    // 작성된 내용을 alert로 출력
